                                                                                ...
                                                                                <td className='border-0 px-0 pt-1 pb-0 align-middle' key={index_day}>
                                                                                    {
                                                                                        ...
                                                                                        <div className='h-100 px-2'>
                                                                                            <div className='p-2 d-flex align-items-center' style={{borderLeft : '.5rem solid #DE496E', backgroundColor : '#DE496E33', borderRadius : '.5rem'}} data-toggle="tooltip" data-placement="top" title={schedule_arr[data_day.id][data_time.name].type === 'schedule' ? schedule_arr[data_day.id][data_time.name].subject.name + ' - ' + schedule_arr[data_day.id][data_time.name].class_model.grade.name + ' - ' + schedule_arr[data_day.id][data_time.name].class_model.name : schedule_arr[data_day.id][data_time.name].name}>
                                                                                                    <div>
                                                                                                        <p className='m-0 schedule_subject h-100' style={{color : '#6B7280', lineHeight : '1rem',}}>
                                                                                                            {schedule_arr[data_day.id][data_time.name].type === 'schedule' ? schedule_arr[data_day.id][data_time.name].subject.name + ' - ' + schedule_arr[data_day.id][data_time.name].class_model.grade.name + ' - ' + schedule_arr[data_day.id][data_time.name].class_model.name : schedule_arr[data_day.id][data_time.name].name}
                                                                                                        </p>
                                                                                                    </div>
                                                                                            </div>
                                                                                        </div>
